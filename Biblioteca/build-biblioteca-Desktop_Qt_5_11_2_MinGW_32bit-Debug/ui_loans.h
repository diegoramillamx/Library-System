...
public:
    ...
    QPushButton *pbPopExistence;
    QTableWidget *twBook;
    QPushButton *pbInsertLoan;
    QPushButton *pbCancelLoan;
    QLabel *label;
    ...
    void setupUi(QMainWindow *Loans)
    {
        ...
        Loans->resize(1060, 520);
        Loans->setMinimumSize(QSize(1060, 520));
        Loans->setMaximumSize(QSize(1060, 520));
        QIcon icon;
        icon.addFile(QStringLiteral(":/book-flat.ico"), QSize(), QIcon::Normal, QIcon::Off);
        Loans->setWindowIcon(icon);
        Loans->setStyleSheet(QStringLiteral(""));
        ...
        pbPushExistence->setGeometry(QRect(10, 100, 211, 81));
        QFont font3;
...
" }"));
        pbPopExistence = new QPushButton(gbBook);
        pbPopExistence->setObjectName(QStringLiteral("pbPopExistence"));
        pbPopExistence->setGeometry(QRect(320, 100, 211, 81));
        pbPopExistence->setFont(font3);
        pbPopExistence->setStyleSheet(QLatin1String("QPushButton#pbPopExistence {\n"
"background-color: rgb(123, 155, 166);\n"
"border-radius: 5px;\n"
" }\n"
"\n"
" QPushButton#pbPopExistence:hover {\n"
"background-color: rgb(65, 91, 118);\n"
"color:  rgb(255, 255, 255);\n"
" }"));
        lbBook->raise();
        ...
        pbInsertLoan->setEnabled(false);
        pbInsertLoan->setGeometry(QRect(720, 260, 271, 81));
...
"color:  rgb(255, 255, 255);\n"
" }"));
        pbCancelLoan = new QPushButton(gbMain);
        pbCancelLoan->setObjectName(QStringLiteral("pbCancelLoan"));
        pbCancelLoan->setEnabled(false);
        pbCancelLoan->setGeometry(QRect(720, 360, 271, 81));
        pbCancelLoan->setFont(font3);
        pbCancelLoan->setStyleSheet(QLatin1String("QPushButton#pbCancelLoan {\n"
"background-color: rgb(123, 155, 166);\n"
"border-radius: 5px;\n"
" }\n"
"\n"
" QPushButton#pbCancelLoan:hover {\n"
"background-color: rgb(65, 91, 118);\n"
"color:  rgb(255, 255, 255);\n"
" }"));
        label = new QLabel(centralwidget);
        label->setObjectName(QStringLiteral("label"));
        label->setGeometry(QRect(-6, -5, 1071, 621));
...
""));
    ...
    void retranslateUi(QMainWindow *Loans)
    {
        ...
        pbPopExistence->setText(QApplication::translate("Loans", "Eliminar seleccionado", nullptr));
        pbInsertLoan->setText(QApplication::translate("Loans", "Guardar el prestamo", nullptr));
        pbCancelLoan->setText(QApplication::translate("Loans", "Cancelar el prestamo", nullptr));
