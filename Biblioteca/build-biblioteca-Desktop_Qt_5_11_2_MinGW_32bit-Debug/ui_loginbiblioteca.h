...
public:
    ...
    void setupUi(QMainWindow *LoginBiblioteca)
    {
        ...
        LoginBiblioteca->resize(412, 290);
        LoginBiblioteca->setMinimumSize(QSize(412, 290));
        LoginBiblioteca->setMaximumSize(QSize(412, 290));
        QFont font;
        ...
        LoginBiblioteca->setStyleSheet(QStringLiteral(""));
        ...
        gbPrimary->setGeometry(QRect(11, 11, 390, 261));
...
" }"));
        ...
        label->setGeometry(QRect(-120, -80, 611, 371));
        label->setStyleSheet(QStringLiteral("background-color: rgb(65, 91, 118);"));
