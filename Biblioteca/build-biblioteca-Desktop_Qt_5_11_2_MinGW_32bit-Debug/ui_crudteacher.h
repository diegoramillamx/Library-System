...
public:
    ...
    void setupUi(QMainWindow *CrudTeacher)
    {
        ...
        CrudTeacher->resize(910, 366);
        CrudTeacher->setMinimumSize(QSize(910, 366));
        CrudTeacher->setMaximumSize(QSize(910, 366));
        QIcon icon;
        icon.addFile(QStringLiteral(":/book-flat.ico"), QSize(), QIcon::Normal, QIcon::Off);
        CrudTeacher->setWindowIcon(icon);
        CrudTeacher->setStyleSheet(QStringLiteral(""));
...
" }"));
        ...
        label_3->setGeometry(QRect(-26, -15, 941, 421));
        label_3->setStyleSheet(QLatin1String("background-color: rgb(65, 91, 118);\n"
""));
        ...
        QObject::connect(lneFirsName, SIGNAL(returnPressed()), lneFatherLastName, SLOT(setFocus()));
        QObject::connect(lneFatherLastName, SIGNAL(returnPressed()), lneMotherLastName, SLOT(setFocus()));
        QObject::connect(lneMotherLastName, SIGNAL(returnPressed()), lneStreet, SLOT(setFocus()));
        QObject::connect(lneStreet, SIGNAL(returnPressed()), lneStreetNumber, SLOT(setFocus()));
        QObject::connect(lneStreetNumber, SIGNAL(returnPressed()), lneColony, SLOT(setFocus()));
        QObject::connect(lneColony, SIGNAL(returnPressed()), lneCity, SLOT(setFocus()));
        QObject::connect(lnePostalCode, SIGNAL(returnPressed()), lneCellphone, SLOT(setFocus()));
        QObject::connect(lneCellphone, SIGNAL(returnPressed()), lnePassword, SLOT(setFocus()));
        QObject::connect(lnePassword, SIGNAL(returnPressed()), lneConfirmPassword, SLOT(setFocus()));
