...
public:
    ...
    void setupUi(QMainWindow *CrudCareer)
    {
        ...
        CrudCareer->setStyleSheet(QStringLiteral(""));
...
" }"));
        ...
        lneCareerQuery->setMaxLength(55);
...
" }"));
        ...
        label->setGeometry(QRect(-16, -5, 701, 431));
...
""));
        ...
        QObject::connect(pbExit2, SIGNAL(clicked()), CrudCareer, SLOT(close()));
    ...
    {
        CrudCareer->setWindowTitle(QApplication::translate("CrudCareer", "Administraci\303\263n de carreras", nullptr));
