...
public:
    ...
    void setupUi(QMainWindow *CrudAuthor)
    {
        ...
        CrudAuthor->setStyleSheet(QStringLiteral(""));
...
" }"));
        ...
        lneIdAuthorQuery->setMaxLength(10);
...
" }"));
        ...
        lneFatherLastNameUpdate->setMaxLength(55);
        ...
        lneMotherLastNameUpdate->setMaxLength(55);
        ...
        lneFirstNameUpdate->setMaxLength(55);
        tabWidget->addTab(tbUpdate, QString());
        label = new QLabel(centralwidget);
        label->setObjectName(QStringLiteral("label"));
        label->setGeometry(QRect(-16, -5, 691, 381));
...
""));
        ...
        QObject::connect(pbExit2, SIGNAL(clicked()), CrudAuthor, SLOT(close()));
