...
public:
    ...
    void setupUi(QMainWindow *CrudStudent)
    {
        ...
        CrudStudent->setStyleSheet(QLatin1String("background-color: rgb(65, 91, 118);\n"
""));
        ...
        pbInsert->setGeometry(QRect(280, 230, 300, 40));
...
" }"));
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/update_contact_info.ico"), QSize(), QIcon::Normal, QIcon::Off);
        pbInsert_3->setIcon(icon2);
...
" }"));
        QIcon icon3;
        icon3.addFile(QStringLiteral(":/door_out.ico"), QSize(), QIcon::Normal, QIcon::Off);
