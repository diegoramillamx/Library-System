...
public:
    ...
    void setupUi(QMainWindow *UpdateBook)
    {
        ...
        UpdateBook->resize(999, 320);
        UpdateBook->setMinimumSize(QSize(999, 320));
        UpdateBook->setMaximumSize(QSize(999, 320));
        QIcon icon;
        icon.addFile(QStringLiteral(":/book-flat.ico"), QSize(), QIcon::Normal, QIcon::Off);
        UpdateBook->setWindowIcon(icon);
        UpdateBook->setStyleSheet(QLatin1String("background-color: rgb(65, 91, 118);\n"
""));
